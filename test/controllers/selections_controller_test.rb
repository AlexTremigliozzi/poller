...
class SelectionsControllerTest < ActionController::TestCase
  ...
  test "should create selection" do
    assert_difference('Selection.count') do
      post :create, selection: { description: @selection.description, name: @selection.name, post_id: @selection.post_id }
    end
  ...
  test "should update selection" do
    patch :update, id: @selection, selection: { description: @selection.description, name: @selection.name, post_id: @selection.post_id }
    assert_redirected_to selection_path(assigns(:selection))
  end
